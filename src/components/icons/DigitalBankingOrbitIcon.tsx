...
export function DigitalBankingOrbitIcon({ className = '', ...props }: IconProps) {
  return (
    <svg
      className={`pointer-events-none absolute left-[-245px] top-[255px] z-0 h-[1246px] w-[480px] select-none ${className}`}
